...
Then open `http://127.0.0.1:5174/`, switch to **AI Admin**, run **Live Approval Journey**, and click **Review impact** on the application evidence panel.
