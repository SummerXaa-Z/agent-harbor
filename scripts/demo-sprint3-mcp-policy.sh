...
RUN_ID="${RUN_ID:-sprint3-$(date +%Y%m%d%H%M%S)}"
...
if kind == "agent":
    ...
    body = {
        ...
        "id": method,
        "method": method,
        "params": {"name": "demo.method", "arguments": {"message": "hello"}},
    }
else:
...
echo "AgentHarbor Sprint 3 MCP method-policy demo"
...
echo "method-policy demo complete"
