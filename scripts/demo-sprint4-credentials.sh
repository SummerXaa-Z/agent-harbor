...
RUN_ID="${RUN_ID:-sprint4-$(date +%Y%m%d%H%M%S)}"
SECRET_VALUE="${SECRET_VALUE:-Bearer sprint4-demo-secret}"
...
body = {
    "name": f"Sprint4 Credentialed MCP {run_id}",
...
echo "AgentHarbor Sprint 4 credential redaction demo"
...
echo "credential redaction demo complete"
