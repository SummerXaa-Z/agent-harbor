...
ADMIN_KEY="${ADMIN_KEY:-}"
RUN_ID="${RUN_ID:-sprint6-$(date +%Y%m%d%H%M%S)}"
...
echo "AgentHarbor Sprint 6 runtime metrics demo"
...
echo "runtime metrics demo complete"
