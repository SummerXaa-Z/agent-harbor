...
assert_file_contains "feedback-log.csv" "handoff_consumer_leg"
assert_file_contains "feedback-log.csv" "upgrade_friction_steps"
assert_file_contains "acceptance-report-notes.md" "Report digest:"
assert_file_contains "acceptance-report-notes.md" "Handoff And Consumer Leg"
assert_file_contains "acceptance-report-notes.md" "Upgrade Friction"
assert_file_contains "evaluator-handoff.md" "self/access-profile"
assert_file_contains "fresh-run-checklist.md" "handoff token"
