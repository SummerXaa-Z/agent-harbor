...
assert_file_contains "scripts/evaluation-readiness.sh" "environment-snapshot.md"
assert_file_contains "scripts/evaluation-readiness.sh" "Working tree:"
...
assert_file_contains "tests/evaluation_readiness_test.sh" "environment-snapshot.md"
